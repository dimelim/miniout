...
const HINTS = [
  {
    text: 'calculo',
    tooltip: 'La materia que leyo del texto. Tocala otra vez para quitarla.',
  },
  {
    text: 'viernes',
    tooltip: 'La fecha que leyo del texto. Manda la nota al dia que toca.',
  },
];
  ...
  return (
    <View className="flex-1 justify-center gap-6">
      <View className="gap-3">
        <View className="rounded-[20px] bg-surface p-4 shadow-surface">
          <Text className="font-sans text-foreground" style={{ fontSize: 15, lineHeight: 23 }}>
            Parcial de calculo el viernes, entra hasta continuidad
          </Text>
      ...
      <View className="gap-2">
        ...
        >
          El campo ya esta abierto
        </Text>
        <Text className="font-sans text-muted" style={{ fontSize: 16, lineHeight: 25 }}>
          No hay boton para crear una nota. La materia y la fecha las lee del texto y te
    ...
    <View className="flex-1 gap-6 pt-2">
      ...
      <View className="gap-2">
        <Text
          ...
          style={{ fontSize: 30, lineHeight: 34, letterSpacing: -0.6 }}
        >
          Lo que mencione un dia, cae aqui
        </Text>
        <Text className="font-sans text-muted" style={{ fontSize: 16, lineHeight: 25 }}>
          Sin crear tareas aparte. Escribes la nota y, si hablaba de un dia, aparece en
          el que toca.
        </Text>
      </View>
